...
const healthCheck = createHealthCheck(dbHafas, '8000207') // Köln Hbf
...
const matchers = {
	...
	self: {
		...
		// todo: https://salzburg-verkehr.at/aus-drei-wird-eins-markenzusammenfuehrung-bei-meridian-bob-und-brb/
	...
	cfl: {
		...
		// https://de.wikipedia.org/wiki/Norddeutsche_Eisenbahngesellschaft_Niebüll
		neg: hasOperatorId('norddeutsche-eisenbahn-gesellschaft'),
	},
	...
	dsb: {
		// https://en.wikipedia.org/wiki/Arriva#Denmark
		arrivaDenmark: hasOperatorId('arriva-danmark'),
